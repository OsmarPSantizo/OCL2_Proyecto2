...
function Calc17(){
    ...
    return(
        <div className="titulo">
            <strong className="Calc">Tasa de comportamiento de casos activos en relación al número de muertes en un continente.</strong>
        ...
        <div className = "col no-gutters">
          ...
          <div className = "leftside">
            ...
            <Form.Group controlId="formFile" className="mb-3">
              ...
              <Form.Label>Selecciona columna para Continente</Form.Label>
              <Form.Control name="dias" placeholder="Columna para Continente" value={cpais2} onChange={(e)=> setcpais(e.target.value)}></Form.Control>
              </Form.Group>
              <h3>Datos</h3>
              <Form.Group>
              <Form.Label>Ingresa el contiente a calcular</Form.Label>
              <Form.Control name="npais" placeholder="Nombre del continente" value={npais2} onChange={(e)=> setnpais(e.target.value)}></Form.Control>
