...
function Calc16(){
    ...
    return(
        <div className="titulo">
            <strong className="Calc">Porcentaje de muertes frente al total de casos en un país, región o continente.</strong>
        ...
        <div className = "col no-gutters">
          ...
          <div className = "leftside">
            ...
            <Form.Group controlId="formFile" className="mb-3">
              ...
              <Form.Control name="confirmados" placeholder="Columna para casos confirmados" value={confirmados2} onChange={(e)=> setconfirmados(e.target.value)}></Form.Control>
              ...
              <Form.Label>Selecciona la columna para país, región o continente</Form.Label>
              ...
              <h3>Datos</h3>
              <Form.Group>
              <Form.Label>Ingresa el país, región o continente a consultar</Form.Label>
              <Form.Control name="prcontiente" placeholder="país, región o continente a consultar" value={npais2} onChange={(e)=> setnpais(e.target.value)}></Form.Control>
