...
function Calc23(){
    ...
    const [nfactor2, setnfactor] = useState("")
    ...
    return(
        <div className="titulo">
            <strong className="Calc">Factores de muerte por COVID-19 en un país.</strong>
        ...
        <div className = "col no-gutters">
          ...
          <div className = "leftside">
            ...
            <Form.Group controlId="formFile" className="mb-3">
              ...
              <Form.Group>
              <Form.Label>Selecciona la columna para Factor de muerte</Form.Label>
              <Form.Control name="pais" placeholder="Columna para factor de muerte" value={confirmados2} onChange={(e)=> setconfirmados(e.target.value)}></Form.Control>
              ...
              <Form.Label>Ingresa el factor a calcular</Form.Label>
              <Form.Control name="npais" placeholder="Factor" value={nfactor2} onChange={(e)=> setnfactor(e.target.value)}></Form.Control>
