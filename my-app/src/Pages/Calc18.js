  ...
  async function handleFile(event){
    ...
    return(
        <div className="titulo">
            <strong className="Calc">Comportamiento y clasificación de personas infectadas por COVID-19 por municipio en un País.</strong>
        ...
        <div className = "col no-gutters">
          ...
          <div className = "leftside">
            ...
            <Form.Group controlId="formFile" className="mb-3">
              ...
              <Form.Label>Selecciona la columna para Municipio</Form.Label>
              <Form.Control name="pais" placeholder="Columna para Municipio" value={cdepar2} onChange={(e)=> setcdepar(e.target.value)}></Form.Control>
              ...
              <Form.Label>Ingresa el municipio a calcular</Form.Label>
              <Form.Control name="npais" placeholder="Nombre del municipio" value={ndepar2} onChange={(e)=> setndepar(e.target.value)}></Form.Control>
