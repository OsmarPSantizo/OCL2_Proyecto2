...
function Calc12(){
    ...
    const [ccomparacion2, setccomparacion] = useState("")
    ...
    return(
        <div className="titulo">
            <strong className="Calc">Ánalisis Comparativo entres 2 paises o continentes.</strong>
        ...
        <div className = "col no-gutters">
          ...
          <div className = "leftside">
            ...
            <Form.Group controlId="formFile" className="mb-3">
              ...
              <Form.Control name="dias" placeholder="Columna para Fecha" value={cdias2} onChange={(e)=> setdias(e.target.value)}></Form.Control>
              ...
              <Form.Label>Selecciona la columna para Comparacion</Form.Label>
              <Form.Control name="vacunados" placeholder="Columna para Comparacion" value={ccomparacion2} onChange={(e)=> setccomparacion(e.target.value)}></Form.Control>
              </Form.Group>
              <h3>Datos</h3>
              <Form.Group>
